...
[![Version](https://img.shields.io/badge/Version-v1.0.88-orange.svg)](https://github.com/celsiainternet/jdb/releases)
...
```bash
go get github.com/celsiainternet/jdb@v1.0.88
```
