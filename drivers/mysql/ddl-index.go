...
* @return string
**/
func (s *Mysql) ddlPrimaryKey(model *jdb.Model) string {
	var result string
...
* @return string
**/
func (s *Mysql) ddlForeignKeys(model *jdb.Model) string {
	var result string
...
* @return string
**/
func (s *Mysql) ddlIndex(model *jdb.Model) string {
	var result string
...
* @return string
**/
func (s *Mysql) ddlUniqueIndex(model *jdb.Model) string {
	var result string
...
* @return string
**/
func (s *Mysql) ddlTableIndex(model *jdb.Model) string {
	result := ""
