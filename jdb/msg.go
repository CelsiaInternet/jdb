...
var (
	...
	MSG_MANY_UPDATE_DATA            = "Many update data, only one is allowed"
	...
	MSG_LIMIT_IS_GREATER_THAN_COUNT = "Limit is greater than count"
	MSG_RESULT_IS_NOT_OK            = "Result is not ok"
)
